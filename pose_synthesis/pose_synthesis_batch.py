...
if __name__ == "__main__":
    ...
    parser.add_argument("--x_values", type=str, default="0,-180,-90,-50,-45,-40,-30-20,-10,10,20,30,40,45,50,90,180", help="comma separated list of x values")
    parser.add_argument("--y_values", type=str, default="0,-180,-90,-50,-45,-40,-30-20,-10,10,20,30,40,45,50,90,180", help="comma separated list of y values")
    ...
    # else:
    #     args.x_values, args.y_values = args.x_values.split(','), args.y_values.split(',')
    # main(args.input_dir, args.output_dir, args.x_values, args.y_values)
    main(args.input_dir, args.output_dir, [0,-180,-90,-50,-45,-40,-30-20,-10,10,20,30,40,45,50,90,180], [0,-180,-90,-50,-45,-40,-30-20,-10,10,20,30,40,45,50,90,180])
